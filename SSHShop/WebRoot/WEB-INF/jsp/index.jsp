		...
		<div class="span24">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					...
					<s:iterator value="hlist" var="hlist">
						<li><a target="_blank" href="${pageContext.request.contextPath }/product_findDetail.action?pid=<s:property value="#hlist.pid"/>"><img
							src="${pageContext.request.contextPath }/<s:property value="#hlist.image" />"
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					...
					<s:iterator value="nlist" var="nlist">
						<li><a target="_blank"  href="${pageContext.request.contextPath }/product_findDetail.action?pid=<s:property value="#nlist.pid"/>"> <img
							src="${pageContext.request.contextPath}/<s:property value="#nlist.image" />"
							style="display: block;"></a></li>
					</s:iterator>
				</ul>
				<ul class="tabContent" style="display: none;">

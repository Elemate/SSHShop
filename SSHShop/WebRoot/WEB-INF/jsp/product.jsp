...
<body>
	...
	<div class="container header">
		<div class="span5">
			<div class="logo">
				<a href="${pageContext.request.contextPath }/index.action"> <img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif"
					alt="传智播客"></a>
			</div>
		</div>
		<div class="span9">
		...
		<div class="span6">
			<div class="hotProductCategory">
				<s:iterator value="#session.clist" var="clist">
					<dl>
						<dt>
							<a href="${pageContext.request.contextPath }/product_findByCid.action?page=1&cid=<s:property value="#clist.cid" />"><s:property value="#clist.cname" /></a>
						</dt>
						<s:iterator value="#clist.categorySeconds" var="cs">
						<dd>
		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：<s:property value="model.shop_price"/>元/份</strong> 市场价：
			...
			<form id="cartForm" action="${pageContext.request.contextPath }/cart_addCart.action" method="post" >
				...
				<div class="action">
					<dl class="quantity">
						<dt>购买数量:</dt>
						<dd>
							<input id="count" name="count"  maxlength="4" value="1" type="text">
						</dd>
						<dd>件</dd>
					</dl>
					<div class="buy">

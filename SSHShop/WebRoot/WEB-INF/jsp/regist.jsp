							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200"> <span><s:fielderror
													fieldName="email" cssStyle="color:red" /></span></td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><input type="text" name="name" class="text"
										maxlength="200" /> <span><s:fielderror
												fieldName="name" cssStyle="color:red" /></span></td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" name="addr" class="text"
										maxlength="200" /> <span><s:fielderror
												fieldName="addr" cssStyle="color:red"></s:fielderror> </span></td>
								</tr>
								<tr>
